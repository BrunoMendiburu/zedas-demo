  ...
  return (
    ...
    >
      ...
      >
        <Link
          href="/"
          className="rounded-md text-base font-bold tracking-tight text-foreground focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-ring"
        >
